        ...
        Column(
            ...
            Row {
                SelectableButton(
                    ...
                    onClick = {
                        viewmodel.onClickActivitySelected(ActivityLevel.Low)
                    },
                ...
                SelectableButton(
                    ...
                    selectedTextColor = Color.White,
                    onClick = {
                        viewmodel.onClickActivitySelected(ActivityLevel.Medium)
                    },
                    textStyle = MaterialTheme.typography.button.copy(
                        fontWeight = FontWeight.Normal
                    )
                ...
                SelectableButton(
                    ...
                    selectedTextColor = Color.White,
                    onClick = {
                        viewmodel.onClickActivitySelected(ActivityLevel.High)
                    },
                    textStyle = MaterialTheme.typography.button.copy(
                        fontWeight = FontWeight.Normal
                    )
