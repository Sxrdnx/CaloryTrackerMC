package com.sxrdnx.core.domain.preferences
...
interface Preferences {
    ...
    fun saveActivityLevel(leve: ActivityLevel)
    ...
    fun loadShouldShowOnboardin():Boolean
    ...
    companion object {
        ...
        const val KEY_SHOULD_SHOW_ONBOARDING = "should_sow_onboarding"
