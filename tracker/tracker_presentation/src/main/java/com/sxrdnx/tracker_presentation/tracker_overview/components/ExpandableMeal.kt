...
import com.sxrdnx.tracker_presentation.tracker_overview.Meal
        ...
        Row(
            ...
            Column(modifier = Modifier.weight(1f)) {
                Row(
                    ...
                    Icon(
                        imageVector = if (meal.isExpanded) Icons.Default.KeyboardArrowUp else Icons.Default.ArrowDropDown,
