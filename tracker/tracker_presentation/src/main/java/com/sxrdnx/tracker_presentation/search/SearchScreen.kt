...
import com.sxrdnx.tracker_presentation.search.components.SearchTextField
import com.sxrdnx.tracker_presentation.search.components.TrackableFoodItem
        ...
        LazyColumn(modifier = Modifier.fillMaxSize()) {
            items(state.trackableFood){food ->
                TrackableFoodItem(
                    ...
                    onAmountChange = {
                        viewModel.onEvent(SearchEvent.OnAmountForFoodChange(food = food.food, amount = it))
                    },
                    onTrack = {
                        keyBoardController?.hide()
                        viewModel.onEvent(
